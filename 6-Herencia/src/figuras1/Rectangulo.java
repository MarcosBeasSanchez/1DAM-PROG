...
public class Rectangulo extends Figura {
	...
	public Rectangulo(String nombre, int x, int y, int color,float grosor, int base, int altura) {
	...
	public String toString() {
		return "Rectangulo [" + super.toString() + "base=" + base + ", altura=" + altura + ", toString()=" + "]";
	}
