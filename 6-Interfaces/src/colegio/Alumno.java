...
public class Alumno extends Persona {
	...
	public void enviarMsgTutor(String mensaje, Profesor profesor) {
		 // Crear una instancia de Mensaje 
        Mensaje mensajeEnviado = new Mensaje(this.getNombre(), LocalDate.now(),  mensaje);
        
        // Agregar el mensaje al buzón del profesor
        profesor.recibirMensaje(mensajeEnviado);
        
        System.out.println(mensaje + " " + LocalDate.now());
        System.out.println("Mensaje enviado desde " + this.getNombre() + " a " + profesor.getNombre() + ": " + mensaje);
    }
	}
